...
ASpectralVisualizer::ASpectralVisualizer()
{
	...
	TimeSynthComponent->bEnableSpectralAnalysis = true; // if you do not add this, it will not do any spectral analysis and the bars won't do anything

	SetRootComponent(TimeSynthComponent);

	for (int32 i = 1; i <= 20; i++)
	{
		//looking at the frequency 50 at a time (50, 100, 150, 200, etc.)
